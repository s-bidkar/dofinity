...
class __TwigTemplate_1083cfc3877b428a946c34d6500bc58fc58cbb5274365c3a02af7127ea7e4310 extends \Twig\Template
{
...
";
        ...
        if ((isset($context["links"]) ? $context["links"] : null)) {
            ...
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["links"]) ? $context["links"] : null)), "html", null, true);
            echo "</div>
";
        }
        // line 18
...
";
    ...
    {
        return new Source("", "core/themes/stable/templates/admin/views-ui-view-preview-section.html.twig", "C:\\wamp64\\www\\dofinity\\core\\themes\\stable\\templates\\admin\\views-ui-view-preview-section.html.twig");
    }
}
